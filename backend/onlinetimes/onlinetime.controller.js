...
const onlinetimesService = require('./onlinetime.service');

// routes
router.post('/writeTimes', writeTimes);
router.get('/getAllOnlinetimes', getAllOnlinetimes);
router.get('/getUserOnlinetimes', getUserOnlinetimes);
...
function getAllOnlinetimes(req, res, next) {
    onlinetimesService.getAll()
        .then(onlinetimes => res.json(onlinetimes))
        .catch(err => next(err));
}

function getUserOnlinetimes(req, res, next) {
    onlinetimesService.getAll()
        .then(onlinetimes => res.json(onlinetimes))
        .catch(err => next(err));
}
